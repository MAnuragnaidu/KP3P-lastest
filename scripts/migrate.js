    ...
    try {
      await prisma.patient.create({
        data: {
          ...
          surgeonSurgicalHistory: patient.surgeonSurgicalHistory || '',
          radiologistFindings: patient.radiologistFindings || '',
          dietitianDietaryFindings: patient.dietitianDietaryFindings || '',
