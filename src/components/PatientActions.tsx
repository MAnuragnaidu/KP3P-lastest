...
function toKP3PPatient(patient: PatientWithUser): PatientData {
  ...
  return {
    ...
    surgeonSurgicalHistory: patient.surgeonSurgicalHistory?.trim() || undefined,
    radiologistFindings: patient.radiologistFindings?.trim() || undefined,
    dietitianDietaryFindings: patient.dietitianDietaryFindings?.trim() || undefined,
