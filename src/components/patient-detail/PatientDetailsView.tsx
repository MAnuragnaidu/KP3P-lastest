...
import { normalizePreviousSurgeryLabels } from '@/lib/previous-ibd-surgeries';
...
export default function PatientDetailsView({ patient }: Props) {
  const parseSurgeries = (() => {
    try {
      const parsed = JSON.parse(patient.previousSurgeries || '[]');
      return Array.isArray(parsed) ? normalizePreviousSurgeryLabels(parsed) : [];
    } catch {
      return [];
    }
  })();
      ...
      <div className="pr-view">
        <div className="pr-body">
          ...
          <div className="pr-main-column">
            ...
            {/* 07 Surgeon — Surgical History */}
            <div className="pr-card">
              <div className="pr-card-head">
                <div className="pr-card-icon" style={{ background: '#fef3c7' }}>🩺</div>
                <span className="pr-card-title">Surgeon — Surgical History</span>
                <span className="pr-card-num">07</span>
              </div>
              <div className="pr-field-grid">
                <div className="pr-field" style={{ gridColumn: '1 / -1' }}>
                  <div className="pr-field-label">Surgical History</div>
                  <div className={`pr-field-value${!patient.surgeonSurgicalHistory?.trim() ? ' empty' : ''}`}>
                    {patient.surgeonSurgicalHistory?.trim() || '—'}
                  </div>
                </div>
              </div>
            </div>

            {/* 08 Radiologist — Radiology Findings */}
            <div className="pr-card">
              <div className="pr-card-head">
                <div className="pr-card-icon" style={{ background: '#dbeafe' }}>📋</div>
                <span className="pr-card-title">Radiologist — Radiology Findings</span>
                <span className="pr-card-num">08</span>
              </div>
              <div className="pr-field-grid">
                <div className="pr-field" style={{ gridColumn: '1 / -1' }}>
                  <div className="pr-field-label">Radiology Findings</div>
                  <div className={`pr-field-value${!patient.radiologistFindings?.trim() ? ' empty' : ''}`}>
                    {patient.radiologistFindings?.trim() || '—'}
                  </div>
                </div>
              </div>
            </div>

            {/* 09 Dietitian — Dietary Findings */}
            <div className="pr-card">
              <div className="pr-card-head">
                <div className="pr-card-icon" style={{ background: '#dcfce7' }}>🥗</div>
                <span className="pr-card-title">Dietitian — Dietary Findings</span>
                <span className="pr-card-num">09</span>
              </div>
              <div className="pr-field-grid">
                <div className="pr-field" style={{ gridColumn: '1 / -1' }}>
                  <div className="pr-field-label">Dietary Findings</div>
                  <div className={`pr-field-value${!patient.dietitianDietaryFindings?.trim() ? ' empty' : ''}`}>
                    {patient.dietitianDietaryFindings?.trim() || '—'}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="pr-card">
              <div className="pr-card-head">
                ...
                <span className="pr-card-num">10</span>
              </div>
            ...
            <div className="pr-card">
              <div className="pr-card-head">
                ...
                <span className="pr-card-num">12</span>
              </div>
              <div className="pr-field-grid">
                <div className="pr-field">
