...
export interface PatientData {
  ...
  surgeonSurgicalHistory?: string;
  radiologistFindings?: string;
  dietitianDietaryFindings?: string;
...
Surgeon — Surgical History: ${patient.surgeonSurgicalHistory?.trim() || 'Not documented'}
Radiologist — Radiology Findings: ${patient.radiologistFindings?.trim() || 'Not documented'}
Dietitian — Dietary Findings: ${patient.dietitianDietaryFindings?.trim() || 'Not documented'}
